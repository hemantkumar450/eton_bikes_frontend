...
@NgModule({
  declarations: [BikeComponent, TopFrameComponent, BikeDetailComponent, TechSupportComponent, GeometryComponent, BuildPriceComponent, DetailImagesComponent, OverviewComponent, FaqComponent, ComponentsComponent, WarrantyAndRegComponent],
