...
export class GeometryComponent implements OnInit {
  ...
  changeInValues(value: number) {
    if (this.isInchesEnabled) {
      const convertedValue = (value / 25.4).toFixed(2);
      return convertedValue !== "NaN" ? convertedValue : "";
    }
    return value;
  }
}
